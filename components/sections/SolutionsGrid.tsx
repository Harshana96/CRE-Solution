          ...
          {solutions.map((solution) => {
            ...
            return (
              <a
                ...
                className="group relative flex flex-col gap-5 rounded-xl border border-brand-line bg-white p-7 transition-all duration-200 hover:-translate-y-1.5 hover:border-brand-red/40 hover:shadow-[0_24px_48px_-24px_rgba(11,15,20,0.28)]"
              >
